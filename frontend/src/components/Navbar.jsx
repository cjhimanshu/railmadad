...
import { FaTrain, FaSignOutAlt, FaUser, FaChartBar } from 'react-icons/fa';
        ...
        <nav className="bg-gradient-to-r from-railway-blue to-blue-700 shadow-xl sticky top-0 z-50">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    {/* Logo */}
                    <Link to={isAdmin ? '/admin' : '/dashboard'} className="flex items-center space-x-2 text-white hover:opacity-80 transition-opacity">
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-2 text-white">
                            ...
                            {isAdmin && (
                                <span className="badge bg-railway-orange text-white ml-2">Admin</span>
                            )}
                        </div>
